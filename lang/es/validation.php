...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute proporcionado se ha filtrado en una brecha de datos. Elija un :attribute diferente.',
    ],
    ...
    'attributes' => [
        'age' => 'edad',
        'answers' => 'respuestas',
        'authorizes_medical_access' => 'autorización de acceso médico',
        'children_count' => 'cantidad de hijos',
        'cohabitation_group' => 'grupo de convivencia',
        'description' => 'descripción',
        'email' => 'correo electrónico',
        'ends_at' => 'fecha de fin',
        'evaluation_ids' => 'encuestas',
        'first_name' => 'nombre',
        'last_name' => 'apellido',
